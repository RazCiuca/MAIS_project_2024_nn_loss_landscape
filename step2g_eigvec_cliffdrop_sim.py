...
if __name__ == "__main__":
    ...
    # plt.subplots(211)
    plt.subplot(121)
    plt.title("cliffdrop power in positive eigen")
    x,y = get_slice_power(pos_eigvals, pos_power, n_slices=50)
    ...
    plt.subplot(122)
    plt.title("cliffdrop power in negative eigen")
    x2, y2 = get_slice_power(np.abs(neg_eigvals), neg_power, n_slices=50)
